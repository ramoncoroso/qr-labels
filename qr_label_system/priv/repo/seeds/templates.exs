...
templates = [
  ...
  # 1. Producto alimentario básico (100×70mm) — EU1169 compliant
  %{
    name: "Producto alimentario",
    description: "Etiqueta completa conforme UE 1169/2011: nombre, ingredientes, alérgenos, peso, lote, caducidad, fabricante",
  ...
  # 3. Etiqueta de vino (100×150mm) — EU1169 compliant
  %{
    name: "Etiqueta de vino",
    description: "Etiqueta completa conforme UE 1169/2011 para vinos: denominación, ingredientes, alérgenos, caducidad, fabricante",
  ...
  # 4. Producto congelado (80×80mm) — EU1169 compliant
  %{
    name: "Producto congelado",
    description: "Etiqueta completa conforme UE 1169/2011 para congelados: ingredientes, alérgenos, peso, caducidad, fabricante",
    width_mm: 80.0, height_mm: 80.0,
    background_color: "#FFFFFF", border_width: 0.3, border_color: "#000000", border_radius: 0.0,
    is_template: true, template_source: "system", template_category: "alimentacion",
    compliance_standard: "eu1169",
    label_type: "multiple",
  ...
  # 7. Medicamento genérico (80×70mm) — FMD compliant
  %{
    name: "Medicamento genérico",
    description: "Etiqueta FMD completa: nombre, principio activo, dosis, lote, caducidad, CN, serial, fabricante, DataMatrix",
    width_mm: 80.0, height_mm: 70.0,
    background_color: "#FFFFFF", border_width: 0.3, border_color: "#000000", border_radius: 0.0,
  ...
  # 8. Muestra médica (70×50mm) — FMD compliant
  %{
    name: "Muestra médica",
    description: "Etiqueta FMD para muestras: nombre, principio activo, lote, caducidad, CN, serial, fabricante, DataMatrix",
    width_mm: 70.0, height_mm: 50.0,
  ...
  # 9. Producto hospitalario (100×65mm) — FMD compliant
  %{
    name: "Producto hospitalario",
    description: "Etiqueta FMD hospitalaria: nombre, principio activo, lote, caducidad, CN, serial, fabricante, DataMatrix",
    width_mm: 100.0, height_mm: 65.0,
    background_color: "#FFFFFF", border_width: 0.3, border_color: "#000000", border_radius: 0.0,
    is_template: true, template_source: "system", template_category: "farmaceutica",
    compliance_standard: "fmd",
    label_type: "multiple",
  ...
  %{
    ...
    elements: [
      ...
      SeedEl.t(SeedEl.id(13,2), 4.0, 9.0, 92.0, 7.0, b: "nombre_destinatario", s: 15.0, w: "bold", n: "Destinatario", cr: "gs1_recipient"),
      SeedEl.t(SeedEl.id(13,3), 4.0, 17.0, 92.0, 5.5, b: "direccion", s: 13.0, n: "Dirección", cr: "gs1_address"),
      SeedEl.t(SeedEl.id(13,4), 4.0, 24.0, 50.0, 5.5, b: "ciudad_cp", s: 13.0, w: "bold", n: "Ciudad/CP", cr: "gs1_address"),
      ...
      SeedEl.t(SeedEl.id(13,7), 30.0, 33.0, 66.0, 4.5, b: "remitente", s: 11.0, n: "Remitente", cr: "gs1_sender"),
      SeedEl.t(SeedEl.id(13,8), 4.0, 39.0, 16.0, 4.5, t: "Ref.:", s: 11.0, c: "#666666", n: "Label ref."),
      SeedEl.t(SeedEl.id(13,9), 21.0, 39.0, 30.0, 4.5, b: "referencia", s: 11.0, w: "bold", n: "Referencia", cr: "gs1_reference"),
  ...
  %{
    ...
    elements: [
      ...
      SeedEl.t(SeedEl.id(14,3), 8.0, 25.0, 132.0, 8.0, b: "nombre_producto", s: 17.0, w: "bold", n: "Producto", cr: "gs1_product"),
      SeedEl.t(SeedEl.id(14,4), 8.0, 36.0, 30.0, 6.0, t: "Cantidad:", s: 13.0, c: "#666666", n: "Label cantidad"),
      SeedEl.t(SeedEl.id(14,5), 40.0, 36.0, 50.0, 7.0, b: "cantidad", s: 15.0, w: "bold", n: "Cantidad", cr: "gs1_quantity"),
      SeedEl.t(SeedEl.id(14,6), 8.0, 46.0, 20.0, 5.5, t: "Lote:", s: 13.0, c: "#666666", n: "Label lote"),
      SeedEl.t(SeedEl.id(14,7), 30.0, 46.0, 50.0, 5.5, b: "lote", s: 13.0, w: "bold", n: "Lote", cr: "gs1_lot"),
      SeedEl.t(SeedEl.id(14,8), 8.0, 55.0, 30.0, 5.5, t: "Peso bruto:", s: 13.0, c: "#666666", n: "Label peso"),
      SeedEl.t(SeedEl.id(14,9), 40.0, 55.0, 40.0, 5.5, b: "peso_bruto", s: 13.0, w: "bold", n: "Peso bruto", cr: "gs1_weight"),
      ...
      SeedEl.t(SeedEl.id(14,12), 32.0, 67.0, 108.0, 5.5, b: "origen", s: 13.0, n: "Origen", cr: "gs1_sender"),
      SeedEl.t(SeedEl.id(14,13), 8.0, 76.0, 25.0, 6.0, t: "Destino:", s: 13.0, c: "#666666", n: "Label destino"),
      SeedEl.t(SeedEl.id(14,14), 35.0, 76.0, 105.0, 6.0, b: "destino", s: 13.0, w: "bold", n: "Destino", cr: "gs1_recipient"),
      SeedEl.l(SeedEl.id(14,15), 8.0, 85.0, 132.0),
      SeedEl.t(SeedEl.id(14,16), 8.0, 90.0, 25.0, 5.5, t: "Fecha:", s: 13.0, c: "#666666", n: "Label fecha"),
      SeedEl.t(SeedEl.id(14,17), 35.0, 90.0, 40.0, 5.5, b: "fecha_envio", s: 13.0, n: "Fecha envío", cr: "gs1_date"),
  ...
  %{
    ...
    elements: [
      ...
      SeedEl.t(SeedEl.id(15,4), 31.0, 19.0, 64.0, 7.0, b: "tracking", s: 15.0, w: "bold", n: "Tracking", cr: "gs1_reference"),
      SeedEl.l(SeedEl.id(15,5), 5.0, 28.0, 90.0),
      SeedEl.t(SeedEl.id(15,6), 5.0, 31.0, 90.0, 7.0, b: "nombre_destinatario", s: 15.0, w: "bold", n: "Destinatario", cr: "gs1_recipient"),
      SeedEl.t(SeedEl.id(15,7), 5.0, 39.0, 90.0, 5.5, b: "direccion", s: 13.0, n: "Dirección", cr: "gs1_address"),
      SeedEl.t(SeedEl.id(15,8), 5.0, 46.0, 90.0, 5.5, b: "ciudad_cp", s: 13.0, w: "bold", n: "Ciudad/CP", cr: "gs1_address"),
      ...
      SeedEl.t(SeedEl.id(15,13), 22.0, 64.0, 73.0, 5.0, b: "referencia", s: 12.0, n: "Referencia", cr: "gs1_reference"),
      SeedEl.t(SeedEl.id(15,14), 5.0, 71.0, 18.0, 5.0, t: "Bultos:", s: 12.0, c: "#666666", n: "Label bultos"),
      SeedEl.t(SeedEl.id(15,15), 24.0, 71.0, 20.0, 5.0, b: "bultos", s: 12.0, w: "bold", n: "Bultos", cr: "gs1_quantity"),
      SeedEl.t(SeedEl.id(15,16), 50.0, 71.0, 16.0, 5.0, t: "Peso:", s: 12.0, c: "#666666", n: "Label peso"),
      SeedEl.t(SeedEl.id(15,17), 67.0, 71.0, 28.0, 5.0, b: "peso_kg", s: 12.0, w: "bold", n: "Peso", cr: "gs1_weight"),
  ...
  %{
    ...
    elements: [
      ...
      SeedEl.t(SeedEl.id(17,4), 25.0, 12.0, 25.0, 7.0, b: "origen", s: 15.0, w: "bold", n: "Origen", cr: "gs1_sender"),
      SeedEl.t(SeedEl.id(17,5), 55.0, 14.0, 10.0, 5.0, t: "→", s: 17.0, a: "center", c: "#999999", n: "Flecha"),
      SeedEl.t(SeedEl.id(17,6), 68.0, 12.0, 28.0, 7.0, b: "destino", s: 15.0, w: "bold", n: "Destino", cr: "gs1_recipient"),
      SeedEl.t(SeedEl.id(17,7), 4.0, 22.0, 20.0, 5.0, t: "Pedido:", s: 12.0, c: "#666666", n: "Label pedido"),
      SeedEl.t(SeedEl.id(17,8), 25.0, 22.0, 30.0, 5.0, b: "num_pedido", s: 12.0, w: "bold", n: "Pedido", cr: "gs1_reference"),
      SeedEl.t(SeedEl.id(17,9), 58.0, 22.0, 18.0, 5.0, t: "Bultos:", s: 12.0, c: "#666666", n: "Label bultos"),
      SeedEl.t(SeedEl.id(17,10), 77.0, 22.0, 19.0, 5.0, b: "bultos", s: 12.0, w: "bold", n: "Bultos", cr: "gs1_quantity"),

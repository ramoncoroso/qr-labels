  ...
  def render(assigns) do
    ...
    <html lang="es" class="h-full">
      <head>
        ...
        <!-- SEO -->
        <title>QR Label System - Generador de Etiquetas con Codigos QR</title>
        <meta name="description" content="Crea etiquetas profesionales con codigos QR. Importa datos desde Excel o CSV, disena tus plantillas y genera lotes de etiquetas listas para imprimir." />
        <meta name="keywords" content="etiquetas QR, generador QR, codigos QR, etiquetas productos, impresion etiquetas, Excel a QR" />

        <!-- Open Graph -->
        <meta property="og:title" content="QR Label System" />
        <meta property="og:description" content="Genera etiquetas con codigos QR desde tus datos. Importa Excel, disena plantillas e imprime." />

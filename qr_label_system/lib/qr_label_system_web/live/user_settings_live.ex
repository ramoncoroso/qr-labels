defmodule QrLabelSystemWeb.UserSettingsLive do
  ...
  def render(assigns) do
    ...
    <.header class="text-center">
      ...
      <:subtitle>Administra tu email y contraseña</:subtitle>
    </.header>
  ...
  def mount(%{"token" => token}, _session, socket) do
    socket =
      case Accounts.update_user_email(socket.assigns.current_user, token) do
        :ok ->
          put_flash(socket, :info, "Email actualizado exitosamente.")
  ...
  def handle_event("update_email", params, socket) do
    ...
    case Accounts.apply_user_email(user, password, user_params) do
      {:ok, applied_user} ->
        ...
        info = "Un enlace para confirmar tu cambio de email ha sido enviado a tu nuevo email."

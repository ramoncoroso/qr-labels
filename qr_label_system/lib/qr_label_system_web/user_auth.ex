defmodule QrLabelSystemWeb.UserAuth do
  @moduledoc """
  Handles user authentication for web requests.
  """
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      QrLabelSystemWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule QrLabelSystemWeb.PageLive do
        use QrLabelSystemWeb, :live_view

        on_mount {QrLabelSystemWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{QrLabelSystemWeb.UserAuth, :ensure_authenticated}] do

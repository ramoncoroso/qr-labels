defmodule QrLabelSystemWeb.UserAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, QrLabelSystemWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "log_out_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      QrLabelSystemWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "require_authenticated_user/2" do
    ...
    test "stores the path to redirect to on GET", %{conn: conn} do
      ...
      halted_conn =
        %{conn | path_info: ["foo"], query_string: "", method: "POST"}
        |> fetch_flash()
        |> UserAuth.require_authenticated_user([])
